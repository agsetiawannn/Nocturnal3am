...
function Work() {
    ...
    return (
        <div>
            ...
            {/* Our Selected Works - Title */}
            <section className="relative z-10 pt-20 md:pt-28 pb-8 bg-black">
                <div className="max-w-6xl mx-auto px-6">
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold italic text-white leading-[1.05]">
                        Our Selected<br />Works
                    </h1>
                </div>
            </section>
            ...
            <section className="relative z-10 pb-12 bg-black">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="hidden md:block">
                        {works.map((work) => (
                            <Link
                                to={`/work/${work.slug}`}
                                key={work.slug}
                                className="block border-t border-white/40 py-8 md:py-10 group transition-all duration-500 hover:bg-white/[0.05] cursor-pointer px-4 -mx-4 rounded-2xl"
                            >
                                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start transition-transform duration-500">
                                    {/* Number */}
                                    <div className="md:col-span-1 md:pt-1">
                                        <span className="text-white/80 group-hover:text-[#16d110] transition-colors duration-500 text-2xl md:text-[32px] font-light">
                                            {work.number}
                                        </span>
                                    </div>

                                    {/* Title + Description */}
                                    <div className="md:col-span-7 md:pr-12 md:pt-1">
                                        <h3 className="text-2xl md:text-[28px] font-bold text-white group-hover:text-[#16d110] transition-colors duration-500 mb-3 tracking-wide">
                                            {work.title}
                                        </h3>
                                        <p className="text-white/60 group-hover:text-white/90 transition-colors duration-500 text-[15px] leading-relaxed md:max-w-[85%]">
                                            {work.description}
                                        </p>
                                    </div>

                                    {/* Tags */}
                                    <div className="md:col-span-4 flex flex-col items-start justify-center gap-3 h-full mt-4 md:mt-0">
                                        {work.tags.map((tag) => (
                                            <span
                                                key={tag}
                                                className="px-6 py-2 rounded-full border border-white/40 text-white/90 group-hover:border-[#16d110] group-hover:text-[#16d110] transition-colors duration-500 text-[11px] uppercase tracking-wider font-light text-left"
                    ...
                    {/* And Many More */}
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-white mt-16 mb-8 leading-tight">
